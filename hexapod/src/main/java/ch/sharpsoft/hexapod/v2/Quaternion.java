...
// * All Rights Reserved.
// */
// package ch.sharpsoft.hexapod.v2;
//
...
// }
//
// public static Quaternion fromAxisAngle(Angle angle, double axisX, double
/// axisY, double axisZ)
// {
// if (angle == null)
// {
...
// }
//
// private static Quaternion fromAxisAngle(Angle angle, double axisX, double
/// axisY, double axisZ, boolean normalize)
// {
// if (angle == null)
// {
// String msg = Logging.getMessage("nullValue.AngleIsNull");
...
// if (normalize)
// {
// double length = Math.sqrt((axisX * axisX) + (axisY * axisY) + (axisZ *
/// axisZ));
...
//
// /**
// * Returns a Quaternion created from three Euler angle rotations. The angles
/// represent rotation about their
// * respective unit-axes. The angles are applied in the order X, Y, Z.
// * Angles can be extracted by calling {@link #getRotationX}, {@link
/// #getRotationY}, {@link #getRotationZ}.
// *
...
//
// // The order in which the three Euler angles are applied is critical. This
/// can be thought of as multiplying
// // three quaternions together, one for each Euler angle (and corresponding
/// unit axis). Like matrices,
...
// // finally by QX. This means that the order of quaternion multiplication is
...
//
// // The order in which the lat/lon angles are applied is critical. This can be
/// thought of as multiplying two
...
// // means that the order of quaternion multiplication is the reverse of the
/// order in which the lat/lon angles
// // are applied.
// //
...
/// (this.z * quaternion.y),
// (this.w * quaternion.y) + (this.y * quaternion.w) + (this.z * quaternion.x) -
/// (this.x * quaternion.z),
// (this.w * quaternion.z) + (this.z * quaternion.w) + (this.x * quaternion.y) -
/// (this.y * quaternion.x),
...
// }
//
// return (this.x * quaternion.x) + (this.y * quaternion.y) + (this.z *
/// quaternion.z) + (this.w * quaternion.w);
// }
//
...
// // ============== Mixing Functions ======================= //
//
// public static Quaternion mix(double amount, Quaternion value1, Quaternion
/// value2)
// {
...
// }
//
// public static Quaternion slerp(double amount, Quaternion value1, Quaternion
/// value2)
// {
// if ((value1 == null) || (value2 == null))
// {
...
// {
// double radians = Math.atan2((2.0 * this.x * this.w) - (2.0 * this.y *
/// this.z),
...
// {
// double radians = Math.atan2((2.0 * this.y * this.w) - (2.0 * this.x *
/// this.z),
...
// {
// double radians = Math.asin((2.0 * this.x * this.y) + (2.0 * this.z *
/// this.w));
// if (Double.isNaN(radians))
// return null;
//
...
// {
// double latRadians = Math.asin((2.0 * this.y * this.w) - (2.0 * this.x *
/// this.z));
// double lonRadians = Math.atan2((2.0 * this.y * this.z) + (2.0 * this.x *
/// this.w),
// (this.w * this.w) - (this.x * this.x) - (this.y * this.y) + (this.z *
/// this.z));
